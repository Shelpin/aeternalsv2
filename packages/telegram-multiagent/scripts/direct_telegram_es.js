...
/**
 * Enhanced Direct Telegram Script (ES Module Version)
 * 
 * This script sends messages directly to the Telegram relay server
 * for testing bot-to-bot communication.
 * 
 * Usage:
 *   node direct_telegram_es.js --server=http://localhost:4000 --token=auth-token --from=bot_name 
...
// Main execution
async function main() {
  console.log('🤖 Enhanced Direct Telegram Script (ES Module Version)');
  console.log('-------------------------------');
